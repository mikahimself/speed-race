...
public class TileMapParts : TileMap
{
    ...
    public static int[][] narrowStraightRight = {
        new int[] {3, 9, 3, 3, 3, 9, 3, 3, 3, 9, 16, 1, 0, 19, 11, 5, },
        new int[] {5, 5, 9, 8, 5, 5, 5, 8, 9, 5, 16, 1, 1, 19, 6, 11, },
        new int[] {4, 4, 11, 4, 9, 4, 11, 4, 3, 11, 16, 1, 0, 19, 3, 4, },
        new int[] {3, 9, 3, 3, 3, 9, 3, 3, 8, 3, 16, 0, 0, 19, 11, 3, },
        new int[] {11, 3, 8, 10, 11, 3, 8, 10, 3, 4, 16, 0, 1, 19, 4, 11, },
        new int[] {4, 4, 4, 11, 4, 4, 4, 11, 9, 3, 16, 0, 1, 19, 3, 8, },
        new int[] {3, 8, 3, 10, 3, 8, 3, 10, 3, 8, 16, 0, 1, 19, 8, 4, },
        new int[] {10, 11, 8, 6, 10, 11, 8, 6, 9, 3, 16, 2, 1, 19, 5, 11, },
        new int[] {4, 4, 4, 8, 4, 4, 4, 8, 5, 11, 16, 1, 2, 19, 3, 8, },
        new int[] {3, 9, 3, 3, 3, 9, 3, 3, 9, 3, 16, 2, 0, 19, 5, 11, },
    };
    ...
    */
    ...
    public static int[] track = {
      13, 15, 5, 4, 0, 9, 1, 8, 2, 7, 3, 3, 6, 2, 2, 5, 1, 1, 4, 0, 0, 0
    };
}
