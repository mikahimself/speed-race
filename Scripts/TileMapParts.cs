...
public class TileMapParts : TileMap
{
    ...
    public static int[][] twoLaneNarrowLeft = {
        new int[] { 1, 2, 0, 34,  1,  1,  1, 41, 0, 0, 0, 9, 1, 1, 1 },
        new int[] { 1, 2, 0, 34,  1,  1,  1, 41, 0, 0, 0, 9, 1, 1, 1 },
        new int[] { 1, 2, 0, 36,  1,  1,  1, 42, 0, 0, 0, 9, 1, 1, 1 },
        new int[] { 1, 2, 0, 38, 45, 45, 45, 43, 0, 0, 0, 9, 1, 1, 1 },
    };
    ...
    */
    ...
    public static int[] track = {
        9, 8, 7, 6, 5, 4, 12, 11, 10, 0, 9, 1, 8, 2, 7, 3, 6, 2, 5, 1, 4, 0, 12, 11, 10,2, 18, 17, 19
    };
}
