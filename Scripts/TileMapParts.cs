...
public class TileMapParts : TileMap
{
    ...
    public static int[][] centerToRight = {
        new int[] { 9,  4, 10,  3,  5,  5,  5,  5,  8, 24, 25,  0,  0,  0, 36,  8, },
        new int[] { 5, 10,  3,  9,  5,  5,  5,  5,  9, 26,  1,  0,  0,  1, 37,  3, },
        new int[] {11,  8,  7,  8,  5,  5,  5,  8,  5, 61,  1,  1,  1,  0, 38,  4, },
        new int[] {10,  6, 11,  3,  5,  5,  5,  9, 59, 60,  1,  1,  0, 48, 47,  9, },
        new int[] { 3,  9,  8,  4,  3,  5,  8,  8, 58,  1,  1,  1,  0, 46,  5,  5, },
        new int[] { 9,  3,  4,  3,  8,  3, 10, 56, 57,  1,  1,  1, 45, 47, 10,  3, },
        new int[] { 3,  8,  3, 11,  6,  8,  9, 61,  0,  1,  0,  0, 49,  8,  6,  6, },
        new int[] { 9,  3,  3,  7,  3, 11, 59, 60,  0,  1,  1, 48, 47, 11,  4,  4, },
        new int[] { 5, 11,  9,  3, 10,  9, 58,  0,  1,  1,  0, 37, 10,  6,  9,  6, },
        new int[] { 9,  3,  7,  4,  3, 59, 60,  0,  1,  0,  1, 38,  3, 11,  5,  8, },
        new int[] { 3,  9,  3, 11,  8, 27,  0,  0,  1,  1, 35, 34,  9,  8,  4,  4, },
        new int[] { 8,  3, 10,  4,  3, 28,  0,  2,  1,  1, 19,  3,  4,  3, 10,  3, },
        new int[] {11,  4,  6,  3,  9, 16,  0,  1,  2,  0, 19, 10,  8,  3,  3,  8, },
        new int[] { 3,  8,  3,  9,  3, 16,  0,  2,  0,  0, 19,  3,  3, 10,  3,  3, },

    };

    public static int[][] rightToCenter = {
        new int[] { 9,  4,  9,  3,  5, 41,  1,  1,  1,  1, 30, 29,  9,  3, 11,  8, },
        new int[] { 5, 10,  3, 10, 11, 52,  1,  1,  1,  1,  0, 31,  4,  9,  3, 11, },
        new int[] {11,  8,  7,  8,  5, 50, 51,  0,  1,  0,  0, 64,  8, 11,  4,  4, },
        new int[] {10,  6, 11,  3,  9, 11, 55,  1,  0,  0,  0, 30, 29,  3,  8,  9, },
        new int[] { 3,  9,  8,  4,  3,  5, 53, 54,  0,  1,  0,  1, 31,  9,  5,  5, },
        new int[] { 9,  3,  4,  3,  8,  3,  9, 42,  1,  0,  0,  1, 32,  3,  4, 10, },
        new int[] { 3,  8,  3, 11,  6,  8,  7, 43,  1,  1,  1,  0, 33,  8,  5,  6, },
        new int[] { 9,  3,  3,  7,  3, 11,  5, 39, 40,  0,  1,  0, 30, 29,  9,  8, },
        new int[] { 5, 11,  9,  3, 10,  5,  9,  5, 41,  1,  0,  1,  1, 31,  5,  6, },
        new int[] { 9,  3,  7,  4,  3,  7,  5, 10, 55,  0,  0,  1,  1, 64,  9,  9, },
        new int[] { 9,  4, 10,  3,  5,  5,  9,  5, 53, 54,  1,  0,  0, 63, 65,  8, },
        new int[] { 5, 10,  3,  9,  5,  5,  5,  5,  9, 52,  0,  0,  0,  1, 32, 11, },
        new int[] {11,  8,  7,  8,  5,  9,  5,  8,  3, 39, 40,  1,  1,  0, 33,  4, },

    };

    public static int[][] centerToLeft = {
        new int[] { 5, 41,  1,  1,  1, 30, 29,  8,  9,  3, 11,  8,  8,  3,  3,  8, },
        new int[] {11, 52,  1,  1,  1,  1, 31,  3,  4,  9,  3, 11,  3, 10,  3,  3, },
        new int[] { 5, 50, 51,  0,  1,  0, 64,  9,  8, 11,  4,  4,  9,  3, 11,  8, },
        new int[] { 9, 11, 55,  1,  0,  0, 66, 62, 10,  3,  8,  9,  4,  9,  3, 11, },
        new int[] { 3,  5, 39, 40,  0,  1,  0, 67,  9, 10,  5,  5,  8, 11,  4,  4, },
        new int[] { 8,  3,  9, 41,  1,  0,  0, 66, 62,  3,  4, 10,  3,  4,  8,  9, },
        new int[] { 6,  8,  7, 52,  1,  1,  1,  0, 64,  8,  5,  6,  4,  9,  5,  5, },
        new int[] { 3, 11,  5, 39, 40,  0,  1,  0, 30, 29,  9,  8,  3,  3,  4, 10, },
        new int[] {10,  5,  9,  6, 41,  1,  0,  1,  1, 31,  5,  6,  5,  8,  5,  6, },
        new int[] { 3,  7,  5, 10, 55,  0,  0,  1,  1, 64,  9,  9,  3,  3,  9,  8, },
        new int[] { 5,  5,  9,  5, 39, 40,  1,  0,  0, 63, 65,  8,  3,  5,  5,  6, },
        new int[] { 5,  5,  5,  5, 11, 16,  0,  0,  0,  1, 32, 11,  5,  3,  9,  9, },
        new int[] { 5,  9,  5,  8,  3, 16,  2,  1,  1,  0, 33,  4,  3,  5,  3,  8, },

    };

    public static int[][] leftToCenter = {
        new int[] { 3,  8,  3,  9,  3, 16,  0,  2,  0,  0, 36,  3,  3, 10,  3,  3, },
        new int[] { 5,  5,  5,  5, 11, 16,  1,  0,  0,  0, 37,  8,  7,  6, 11,  3, },
        new int[] { 5,  5,  5, 10, 24, 25,  1,  0,  0,  1, 38,  3, 11,  9,  8,  4, },
        new int[] { 5,  5,  5,  8, 26,  0,  1,  1,  1, 45, 47, 11,  7,  8,  5,  9, },
        new int[] { 5,  5,  5,  9, 27,  1,  1,  1,  0, 46, 11,  5, 11,  3,  9,  5, },
        new int[] { 3,  5,  8,  8, 28,  1,  1,  1, 48, 47,  8,  5,  8,  4,  3,  5, },
        new int[] { 8,  3, 10, 56, 57,  1,  1,  1, 46, 11, 10,  3,  4,  3,  8,  3, },
        new int[] { 6,  8,  9, 61,  0,  0,  0, 45, 47,  6,  6,  6,  3, 11,  6,  8, },
        new int[] { 3, 11, 59, 60,  0,  0,  0, 49,  8,  6,  9,  6,  3, 11,  6,  8, },
        new int[] {10,  9, 58,  0,  1,  1, 48, 47, 11,  4,  4,  4,  3,  7,  3, 11, },
        new int[] { 3, 59, 60,  0,  1,  0, 37, 10,  6,  9,  6,  6,  9,  3, 10,  5, },
        new int[] { 8, 27,  0,  0,  1,  1, 38,  3, 11,  5,  8,  8,  7,  4,  3,  7, },
        new int[] { 3, 28,  0,  2,  1, 35, 34,  9,  8,  4,  4,  4, 10,  3, 11,  5, },
    };


    public static int[][] narrowStraightLeft = {
        new int[] { 3, 16,  1,  0,  0, 19, 11,  3,  3,  8,  7,  8,  5,  9,  5,  8, },
        new int[] { 9, 16,  1,  0,  1, 19,  5,  8,  7,  6, 11,  3,  9,  5,  5,  9, },
        new int[] { 8, 16,  1,  1,  0, 19, 10,  6, 11,  9,  8,  4,  3,  5,  9,  7, },
        new int[] {11, 16,  0,  1,  0, 19,  6,  8,  7,  8,  5,  9,  5,  8, 10,  5, },
        new int[] { 5, 16,  0,  1,  1, 19,  8,  6, 11,  3,  9,  5,  5,  9,  5,  8, },
        new int[] { 5, 16,  1,  1,  1, 19,  6,  9,  8,  4,  3,  5,  9,  7,  5,  9, },
        new int[] { 9, 16,  1,  1,  1, 19,  9,  3,  4,  3,  8,  3, 10,  5,  9,  7, },
        new int[] { 3, 16,  1,  0,  0, 19,  9,  8,  3, 11,  6,  8,  7,  5, 10,  5, },
        new int[] { 9, 16,  1,  0,  1, 19,  5,  3,  3,  7,  3, 11,  5,  7,  7,  5, },
        new int[] { 8, 16,  1,  1,  0, 19, 10, 11,  9,  3, 10,  5,  9,  5,  5,  7, },
    };
